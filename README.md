...
| الميزة | التفاصيل |
|---|---|
| **skills.md موحّد** | دمج soul.md + tools.md → ملف واحد 600+ سطر |
| **Plan-and-Solve + Reflexion** | معمارية تفكير جديدة: خطة → تنفيذ → مراجعة → تحديث |
| **AX Tree scraping** | 3 مستويات: Playwright / Stealth / AX Tree الدلالي |
| **Thinking bubble** | تصميم جديد مع زر إخفاء/إظهار وscroll داخلي |
| **UI نظيف** | حذف كل الحواف السوداء عند hover، حذف hint text |
